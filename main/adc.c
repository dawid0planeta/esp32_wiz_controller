...
{
    double scaled = (double)ch1_avg * 0.0247933884297521 + 9.00826446280992;
    // ESP_LOGI(TAG, "raw: %lf, scaled: %lf", (double)ch1_avg, scaled);
    // 19-20 is the difference between cozy lightness
    return scaled;
}
